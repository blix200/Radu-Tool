...
\t\t   
\t\t  
                                          Welcome {username} | https://discord.gg/https://discord.gg/7Yke6NK9F4 
                            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════""", Colors.red_to_blue, interval=0.0000)
    ...
    if opc=="$":
        Write.Print(f"""
[!] This version is the payed version of Eznuke!. 

Discord : https://discord.gg/7Yke6NK9F4
Email : blixscripting@gmail.com
Github : soon ~> """, Colors.purple_to_red, interval=0.000); input()
        radu_tool2()
    if opc=="+":
    ...
    if opc=="30":
        ...
        if bio == "" or bio == None:
            bio = "https://discord.gg/7Yke6NK9F4"
        else:
            bio = bio
...
\t\t  ▐     ▐   ▐   ▐   █     ▐                 █                             █         
\t\t                    ▐                       ▐                             ▐   
                                          Welcome {username} | discord.gg/7Yke6NK9F4  
                            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                        ( ! ) Send Suggestion           |           ( + ) Check Update  
                                                ( $ ) Paid Menu
════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
    ...
    Write.Print(f"\nroot@eznuke ~> ", Colors.red_to_blue, interval=0.000); opc = input(magenta).lower()
    if opc=="x" or opc=="exit" or opc=="esc":
        System.Clear()
        bye_bye(username, date_now)
    if opc=="$":
...
Github : soon~> """, Colors.purple_to_red, interval=0.000); input()
    ...
    if opc=="1":
        ...
        Write.Print(f"""\n\n
                                    ╔═════════════════════════════════════════╗
                                    ║   EZNUKE TOOLZ MULTI-TØØL TOKEN CHECKER STATS  ║
                                ╔═════════════════════════════════════════════════╗
...
════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
""", Colors.purple_to_red, interval=0.000)
        Write.Print(f"\nroot@Eznuke! ~> ", Colors.red_to_blue, interval=0.000); opc2 = input(magenta).lower()
        if opc2=="1":
